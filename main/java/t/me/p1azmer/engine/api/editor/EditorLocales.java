...
public class EditorLocales {
    ...
    public static final EditorLocale CLOSE = EditorLocale.of("Editor.Generic.Close", "#FF5733(\u2715) &lВыйти");
    public static final EditorLocale RETURN = EditorLocale.of("Editor.Generic.Return", "#ffee9a(\u2193) &fНазад");
    public static final EditorLocale NEXT_PAGE = EditorLocale.of("Editor.Generic.NextPage", "#e3fbf9(\u2192) &lСледующая страница");
    public static final EditorLocale PREVIOUS_PAGE = EditorLocale.of("Editor.Generic.PreviousPage", "#e3fbf9(\u2190) &lПредыдущая страница");
    ...
    protected static final class Builder {
        ...
        public Builder currentHeader() {
            return this.addLore(YELLOW + "&l", "Сейчас:");
        }
        ...
        public Builder warningHeader() {
            return this.addLore(RED + "&l", "Внимание:");
        }
        ...
        public Builder noteHeader() {
            return this.addLore(ORANGE + "&l", "Примечание:");
        }
        ...
        public Builder actionsHeader() {
            return this.addLore(GREEN + "&l", "Действия:");
        }
