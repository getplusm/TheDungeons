...
public class UndergroundGenerator implements LocationGenerator {
    ...
    public UndergroundGenerator(ConfigContainer configContainer, RegionHandler regionHandler) {
    ...
    private void generateLocation(World world, WorldGenerationInfo generationInfo) {
        ...
        while (!generated && attempts > 0) {
            ...
            Location result = findRandomLocation(world, generationInfo, GenerationType.UNDERGROUND, regionHandler);
