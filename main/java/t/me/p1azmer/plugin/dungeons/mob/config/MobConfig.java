...
public class MobConfig extends AbstractConfigHolder<DungeonPlugin> implements IPlaceholderMap {
    ...
    public boolean load() {
        ...
        for (Attribute attribute : Attribute.values()) {
            double valueBase = cfg.getDouble(path + attribute.name());
            if (valueBase > 0) {
    ...
    public void setEnabledSpawn(boolean enabledSpawn) {
        this.enabledSpawn = enabledSpawn;
    }
