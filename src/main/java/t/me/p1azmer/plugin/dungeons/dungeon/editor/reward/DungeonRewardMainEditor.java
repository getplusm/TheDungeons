...
public class DungeonRewardMainEditor extends EditorMenu<DungeonPlugin, Reward> {
    ...
    public DungeonRewardMainEditor(@NotNull Reward reward) {
        ...
        this.addReturn(40).setClick((viewer, event) -> this.plugin.runTask(task -> dungeon.getEditor().getEditorRewards().open(viewer.getPlayer(), 1)));
        ...
        this.addItem(Material.COMPARATOR, EditorLocales.REWARD_CHANCE, 20).setClick((viewer, event) -> this.handleInput(viewer, Lang.EDITOR_REWARD_ENTER_CHANCE, wrapper -> {
