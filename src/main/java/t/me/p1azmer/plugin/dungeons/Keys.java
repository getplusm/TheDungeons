...
public class Keys {
    public static final NamespacedKey DUNGEON_KEY_ID = new NamespacedKey(DungeonAPI.PLUGIN, "dungeons.key.id");
    public static final NamespacedKey DUNGEON_CHEST_BLOCK = new NamespacedKey(DungeonAPI.PLUGIN, "dungeons.block");
