...
public interface EditorButtonType {
    ...
    String PREFIX_INFO = "&6[?] Описание:";
    String PREFIX_NOTE = "&e[!] Примечание:";
    String PREFIX_WARN = "&c[!] Предупреждение:";
    String PREFIX_CLICK = "#55e136[>] Действия:";
    String PREFIX_CURRENT = "&b[?] Текущий:";
    String COLOR_GRAY = "&7";
    ...
    default ItemStack getItem() {
        ...
        meta.setDisplayName(Colorizer.apply("&e") + this.getName());
