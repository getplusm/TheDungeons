...
public class Reward extends AbstractSettings implements ICleanable, Placeholder {
    ...
    DungeonRewardMainEditor editor;

    public Reward(@NotNull Dungeon dungeon, @NotNull String id) {
        this(dungeon, id, 25, UniInt.of(1, 3), new ItemStack(Material.DIAMOND), new ArrayList<>());
    }

    public Reward(@NotNull Dungeon dungeon, @NotNull String id,
                  double chance, UniInt amount,
                  @NotNull ItemStack item, @NotNull List<String> commands) {
        super(dungeon);
