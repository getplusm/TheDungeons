...
public class Lang extends EngineLang {
    ...
    public static final LangKey EDITOR_GENERIC_ENTER_NAME = LangKey.of("Editor.Generic.Enter.Name", GRAY + "Enter " + GREEN + "[Display Name]");
    public static final LangKey EDITOR_GENERIC_ENTER_DESCRIPTION = LangKey.of("Editor.Generic.Enter.Description", GRAY + "Enter " + GREEN + "[Description]");
    public static final LangKey EDITOR_GENERIC_ENTER_COMMAND = LangKey.of("Editor.Generic.Enter.Command", GRAY + "Enter " + GREEN + "[Command]");
    public static final LangKey EDITOR_GENERIC_ENTER_NUMBER = LangKey.of("Editor.Generic.Enter.Number", GRAY + "Enter " + GREEN + "[Number]");
    public static final LangKey EDITOR_GENERIC_ENTER_PERCENT = LangKey.of("Editor.Generic.Enter.Percent", GRAY + "Enter " + GREEN + "[Percent Amount]");
    ...
    public static final LangKey EDITOR_DUNGEON_WRITE_VALUE = LangKey.of("Editor.Dungeon.Write.Value", GREEN + GRAY + "Enter " + GREEN + "value" + GRAY + "...");
    ...
    public static final LangKey Editor_Dungeon_Enter_World = new LangKey("Editor.Dungeon.Enter.World", GRAY + "Enter " + GREEN + "world name" + GRAY + "...");
    public static final LangKey Editor_Dungeon_World_Not_Found = new LangKey("Editor.Dungeon.Error.World.Not_Found", RED+"World not found!");

    public static final LangKey Editor_Mob_Enter_Create = new LangKey("Editor.Mob.Enter.Create", GRAY + "Enter " + GREEN + "unique " + GRAY + "mob " + GREEN + "identifier" + GRAY + "...");
    public static final LangKey Editor_Mob_Enter_Type = new LangKey("Editor.Mob.Enter.Type", GRAY + "Enter " + GREEN + "entity type" + GRAY + "...");
    public static final LangKey Editor_Mob_Enter_Attribute = new LangKey("Editor.Mob.Enter.Attribute", GRAY + "Enter " + GREEN + "attribute " + GRAY + "and " + GREEN + "value" + GRAY + "...");
    public static final LangKey Editor_Mob_Enter_Id = new LangKey("Editor.Mob.Enter.Id", GRAY + "Enter " + GREEN + "mob id " + GRAY + "and" + GREEN + "amount of" + GRAY + "...");
    public static final LangKey Editor_Mob_Enter_Potion = new LangKey("Editor.Mob.Enter.Potion", GRAY + "Enter " + GREEN + "potion " + GRAY + "and " + GREEN + "value" + GRAY + "...");
