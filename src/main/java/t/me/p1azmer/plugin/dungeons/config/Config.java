...
public class Config {
    public static final String DIR_ANNOUNCE = "/announce/";
    ...
    public static final JOption<Boolean> DUNGEON_HOLD_KEY_TO_OPEN = JOption.create(
            "Settings.Dungeon.Hold_Key_To_Open",
            false,
    ...
    public static final JOption<Boolean> TICK_DEBUG = JOption.create(
            "Settings.Debug.Tick",
            false,
            "Enables dungeon tick debugging"
    );
    public static final JOption<Boolean> TICK_CHEST_DEBUG = JOption.create(
            "Settings.Debug.Tick_Chest",
            false,
            "Enables dungeon chest tick debugging"
    );
    public static final JOption<Boolean> MODULE_DEBUG = JOption.create(
